...
$(document).ready(function () {
  ...
  if (isMobile) {
    console.log('workflow_mobile');
    $("#workflow_mobile").slick({
...
function cambialogo(cual) { 
  $(".landindreel-footer-logo-blanco").hide()
  $(".landindreel-footer-logo-rojo").hide()
  $(".landindreel-footer-logo-" +cual).fadeIn();
